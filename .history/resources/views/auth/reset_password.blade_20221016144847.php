...
<body>
<div class="flex-center position-ref full-height">x
    <form class="form-container" action="api/reset-password" method="POST">
        ...
        @error('email') <span class="text-red-600 px-6 error">{{ $message }}</span> @enderror
        <input name="password" placeholder="Enter new password">
        @error('password') <span class="text-red-600 px-6 error">{{ $message }}</span> @enderror
        <input name="password_confirmation" placeholder="Confirm new password">
        @error('password_confirmation') <span class="text-red-600 px-6 error">{{ $message }}</span> @enderror
